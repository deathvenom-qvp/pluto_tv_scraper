...
The server mode can do one other thing:
- The `--refresh <seconds>` option, which will refetch the playlists and xml files the files at (at least) one hour intervals
